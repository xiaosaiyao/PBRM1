...
#saveRDS(chipseq, "project213.BRG1.chipseq.rds")
chipseq <- readRDS("project213.BRG1.chipseq.rds")
...
#saveRDS(contrast.WT, "project213.BRG1.WT.BTZ.contrast.rds")
#contrast.WT <- readRDS("project213.BRG1.WT.BTZ.contrast.rds")

#plot MA plot
#pdf("project213.BRG1.WT.BTZ.MAplot.pdf")
#dba.plotMA(contrast.WT, th=0.1, yrange=c(-10,10), fold=log2(1.5))
#dev.off()
...
#export.bed(report.gain, "project213.diffbind.786O.BRG1.WT.BTZ.gain.bed")
#export.bed(report.lost, "project213.diffbind.786O.BRG1.WT.BTZ.lost.bed")
#export.bed(report.all, "project213.diffbind.786O.BRG1.WT.BTZ.all.bed")
...
saveRDS(contrast.KO, "project213.BRG1.KO.BTZ.contrast.rds")
#contrast.KO <- readRDS("project213.BRG1.KO.BTZ.contrast.rds")

#plot MA plot
pdf("project213.BRG1.KO.BTZ.MAplot.pdf")
...
export.bed(report.gain, "project213.diffbind.786O.BRG1.KO.BTZ.gain.bed")
export.bed(report.lost, "project213.diffbind.786O.BRG1.KO.BTZ.lost.bed")
export.bed(report.all, "project213.diffbind.786O.BRG1.KO.BTZ.all.bed")
