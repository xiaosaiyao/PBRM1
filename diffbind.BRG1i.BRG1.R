...
samples <- read.csv("project214.BRG1.csv",stringsAsFactors=F)
...
saveRDS(chipseq, "project214.BRG1.chipseq.rds")
chipseq <- readRDS("project214.BRG1.chipseq.rds")
#### WT ####
...
saveRDS(contrast.WT, "project214.BRG1.WT.BRG1i.contrast.rds")
contrast.WT=readRDS("project214.BRG1.WT.BRG1i.contrast.rds")

#plot MA plot
pdf("project214.BRG1.WT.BRG1i.MAplot.pdf")
...
export.bed(report.gain, "project214.diffbind.786O.BRG1.WT.BRG1i.gain.bed")
export.bed(report.lost, "project214.diffbind.786O.BRG1.WT.BRG1i.lost.bed")
export.bed(report.all, "project214.diffbind.786O.BRG1.WT.BRG1i.all.bed")
...
saveRDS(contrast.KO, "project214.BRG1.KO.BRG1i.contrast.rds")
contrast.KO=readRDS("project214.BRG1.KO.BRG1i.contrast.rds")

#plot MA plot
pdf("project214.BRG1.KO.BRG1i.MAplot.pdf")
...
export.bed(report.gain, "project214.diffbind.786O.BRG1.KO.BRG1i.gain.bed")
export.bed(report.lost, "project214.diffbind.786O.BRG1.KO.BRG1i.lost.bed")
export.bed(report.all, "project214.diffbind.786O.BRG1.KO.BRG1i.all.bed")
